...
//		employee.setName("Luice Smith");
//		employee.setDept("Finance");
//		employee.setSalary(67896.67);
//		System.out.println(employee);
		
//		IOC :Inversion of Control ==> Dependency Injection
		
//		1. Application Context Container type : Loads every bean at startup time.
...
//		2. Bean Factory Container : loads bean on requirement
